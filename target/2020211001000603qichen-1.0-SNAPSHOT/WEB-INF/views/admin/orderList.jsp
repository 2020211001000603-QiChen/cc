			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.qichen.model.Order o=(com.qichen.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.qichen.dao.UserDao userDao=new com.qichen.dao.UserDao();
						...
						<%
							...
							String paymentType=com.qichen.model.Payment.findByPaymentId(con,n);
							 %>
